...
import { SelectField, CircularLoader } from '@dhis2/ui-core';
...
var SelectFieldWithMargin = withMargin(SelectField);
var Category = function Category(props) {
  return React.createElement(SelectFieldWithMargin, _extends({}, withKind(props), {
    name: "category",
...
function (_Component) {
  ...
  _createClass(DateRange, [{
    ...
    value: function render() {
      ...
      }, React.createElement("label", null, i18n.t('Start Date')), React.createElement("input", {
        className: START_DATE,
        type: "date",
        value: startDate,
        onChange: this.onStartDateChange
      }), startDateError && React.createElement("span", {
        className: "uaa-date-input-error ".concat(START_DATE)
      }, startDateError)), React.createElement("div", {
        className: "uaa-date-field uaa-fieldwrap"
      }, React.createElement("label", null, i18n.t('End date')), React.createElement("input", {
        className: END_DATE,
        type: "date",
        value: endDate,
        onChange: this.onEndDateChange
      }), endDateError && React.createElement("span", {
...
function FilterSideBar(_ref) {
  ...
  }, i18n.t('Usage Analytics')), React.createElement(CategoryDropDown, null), showDateFields && React.createElement(Fragment, null, React.createElement(DateRange$1, null), React.createElement(IntervalDropDown, null)), showFavoriteViewsFields && React.createElement(Fragment, null, React.createElement(AggregationLevelDropDown, null), React.createElement(ChartTypeDropDown, null)), showTopFavoritesFields && React.createElement(Fragment, null, React.createElement(EventTypeDropDown, null), React.createElement(PageSizeDropDown, null), React.createElement(SortOrderDropDown, null)));
}
...
function Chart$1(_ref) {
  ...
  if (shouldHide) {
    ...
    content = React.createElement(CircularLoader, {
      overlay: true
    });
  } else {
...
var TableHead = function TableHead(_ref) {
  ...
  return React.createElement("thead", null, React.createElement("tr", null, headers.map(function (header, i) {
...
var TableBody = function TableBody(_ref2) {
  var rows = _ref2.rows;
  return React.createElement("tbody", null, rows.map(function (row, i) {
...
var TableRow = function TableRow(_ref3) {
  ...
  return React.createElement("tr", null, cells.map(function (text, i) {
...
function Table(_ref4) {
  ...
  if (error) {
    content = React.createElement(Error$1, {
  ...
  _createClass(UsageAnalytics, [{
    ...
    value: function render() {
      ...
      if (appStatus === LOADING) {
        return React.createElement(CircularLoader, {
          overlay: true,
          size: "large"
        });
      }
      ...
      if (appStatus === ERROR) {
        return React.createElement(Error$1, {
      ...
      }, React.createElement(FilterSideBar$1, null), React.createElement("section", {
        className: "uaa-content"
      }, React.createElement(Chart$2, null), React.createElement(Table$1, null)));
    }
  }]);
...
function App() {
  return React.createElement(lib_1, {
    store: store
  }, React.createElement(UsageAnalytics$1, null));
}
