...
unwrapExports(redux);
var redux_1 = redux.createStore;
var redux_2 = redux.combineReducers;
var redux_3 = redux.bindActionCreators;
var redux_4 = redux.applyMiddleware;
var redux_5 = redux.compose;
var redux_6 = redux.__DO_NOT_USE__ActionTypes;
...
unwrapExports(lib$1);
var lib_1 = lib$1.Provider;
var lib_2 = lib$1.connectAdvanced;
var lib_3 = lib$1.ReactReduxContext;
var lib_4 = lib$1.connect;
var lib_5 = lib$1.useDispatch;
var lib_6 = lib$1.createDispatchHook;
var lib_7 = lib$1.useSelector;
var lib_8 = lib$1.createSelectorHook;
var lib_9 = lib$1.useStore;
var lib_10 = lib$1.createStoreHook;
var lib_11 = lib$1.batch;
var lib_12 = lib$1.shallowEqual;
...
var ReduxThunk = unwrapExports(lib$2);
...
var APP_LOAD_ERROR = 'APP_LOAD_ERROR'; // STATISTICS

var USAGE_DATA_REQUESTED = 'USAGE_DATA_REQUESTED';
var USAGE_DATA_RECEIVED = 'USAGE_DATA_RECEIVED';
var USAGE_DATA_ERRORED = 'USAGE_DATA_ERRORED'; // FILTER
...
var _CATEGORY_LOOKUP;
var FAVORITE_VIEWS = 'FAVORITE_VIEWS';
var FAVORITES_SAVED = 'FAVORITES_SAVED';
var USERS = 'USERS';
var TOP_FAVORITES = 'TOP_FAVORITES';
var DATA_VALUES = 'DATA_VALUES';
var CATEGORY_LOOKUP = (_CATEGORY_LOOKUP = {}, _defineProperty(_CATEGORY_LOOKUP, FAVORITE_VIEWS, {
  value: FAVORITE_VIEWS,
  label: i18n.t('Favorite views'),
  subtitle: i18n.t('Number of times users looked at analysis favorites')
}), _defineProperty(_CATEGORY_LOOKUP, FAVORITES_SAVED, {
  value: FAVORITES_SAVED,
  label: i18n.t('Favorites saved'),
  subtitle: i18n.t('Number of analysis favorites created by users')
}), _defineProperty(_CATEGORY_LOOKUP, USERS, {
  value: USERS,
  label: i18n.t('Users'),
  subtitle: i18n.t('Number of users in the system')
}), _defineProperty(_CATEGORY_LOOKUP, TOP_FAVORITES, {
  value: TOP_FAVORITES,
  label: i18n.t('Top favorites')
}), _defineProperty(_CATEGORY_LOOKUP, DATA_VALUES, {
  value: DATA_VALUES,
  label: i18n.t('Data values'),
  subtitle: i18n.t('Number of data values saved in the system')
}), _CATEGORY_LOOKUP);
var CATEGORIES = [CATEGORY_LOOKUP.FAVORITE_VIEWS, CATEGORY_LOOKUP.FAVORITES_SAVED, CATEGORY_LOOKUP.USERS, CATEGORY_LOOKUP.TOP_FAVORITES, CATEGORY_LOOKUP.DATA_VALUES];
...
var REPORT_TABLE_VIEW = 'REPORT_TABLE_VIEW';
var EVENT_REPORT_VIEW = 'EVENT_REPORT_VIEW';
var EVENT_CHART_VIEW = 'EVENT_CHART_VIEW';
var DASHBOARD_VIEW = 'DASHBOARD_VIEW';
var DATA_SET_REPORT_VIEW = 'DATA_SET_REPORT_VIEW';
var EVENT_TYPES = [{
  value: CHART_VIEW,
  label: i18n.t('Chart')
}, {
...
function filter() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : getInitialState(new Date());
  ...
  switch (type) {
    case FILTER_UPDATED:
      return _objectSpread2({}, state, _defineProperty({}, payload.key, payload.value));

    default:
      return state;
  }
}
function getInitialState(endDate) {
...
var rootReducer = redux_2({
  appStatus: appStatus,
  usageData: usageData,
  filter: filter
});
var store = redux_1(rootReducer, redux_4.apply(void 0, middlewares));

if (!process.env.REACT_APP_DHIS2_BASE_URL) {
  throw new Error('The environment variable REACT_APP_DHIS2_BASE_URL must be set');
}

var url = process.env.REACT_APP_DHIS2_BASE_URL;
var endpoint = "".concat(url, "/api");
var defaultConfig = {
  method: 'GET',
  credentials: 'include'
};
function get(path) {
  ...
  return fetch("".concat(endpoint, "/").concat(path), config).then(function (response) {
    if (response.ok) {
      return response;
    }
...
function getJSON(path) {
  return get(path).then(function (response) {
...
function getFavorites(_ref) {
  var eventType = _ref.eventType,
      pageSize = _ref.pageSize,
      sortOrder = _ref.sortOrder;
  var queryParams = "eventType=".concat(eventType, "&pageSize=").concat(pageSize, "&sortOrder=").concat(sortOrder, "&_=").concat(Date.now());
  return getJSON("dataStatistics/favorites?".concat(queryParams));
}
function getDataStatistics(_ref2) {
  var startDate = _ref2.startDate,
      endDate = _ref2.endDate,
      interval = _ref2.interval;
  var queryParams = "startDate=".concat(startDate, "&endDate=").concat(endDate, "&interval=").concat(interval, "&_=").concat(Date.now());
  return getJSON("dataStatistics?".concat(queryParams));
}
function getUsageData(filter) {
  return filter.category === TOP_FAVORITES ? getFavorites(filter) : getDataStatistics(filter);
}
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return getUsageData(getState().filter);

              case 3:
                payload = _context.sent;
                dispatch(createAction(APP_LOAD_SUCCESS, payload));
                _context.next = 11;
                break;
              ...
              case 7:
                ...
                dispatch(createAction(APP_LOAD_ERROR, _context.t0));
...
var updateCategory = function updateCategory(e) {
  return function (dispatch, getState) {
    ...
    var oldCategory = filter.category;
    dispatch(updateFilter(e.target.name, e.target.value));

    if (isNewDataRequiredAfterCategoryChange(oldCategory, e.target.value)) {
      return getUsageData$1(_objectSpread2({}, filter, {
        category: e.target.value
      }), dispatch);
    }
  };
};
var updateFilterAndGetData = function updateFilterAndGetData(e) {
  return function (dispatch, getState) {
    dispatch(updateFilter(e.target.name, e.target.value));
    ...
    return getUsageData$1(filter, dispatch);
  };
};
var updateUsageData = function updateUsageData() {
  return function (dispatch, getState) {
    var _getState3 = getState(),
        filter = _getState3.filter;

    return getUsageData$1(filter, dispatch);
  };
};
var updateFilter = function updateFilter(key, value) {
  return createAction(FILTER_UPDATED, {
    key: key,
    value: value
  });
};
function isNewDataRequiredAfterCategoryChange(oldCategory, newCategory) {
...
function getUsageData$1(_x3, _x4) {
  return _getUsageData.apply(this, arguments);
}

function _getUsageData() {
  _getUsageData = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(filter, dispatch) {
    var usageData;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            dispatch(createAction(USAGE_DATA_REQUESTED));
            _context2.prev = 1;
            _context2.next = 4;
            return getUsageData(filter);

          case 4:
            usageData = _context2.sent;
            dispatch(createAction(USAGE_DATA_RECEIVED, usageData));
            _context2.next = 12;
            break;
          ...
          case 8:
            ...
            dispatch(createAction(USAGE_DATA_ERRORED, _context2.t0));
...
var css$1 = ".uaa-fieldwrap {\n    margin-bottom: 16px;\n}\n";
styleInject(css$1);

function withMargin(ComponentToWrap) {
  return function ComponentWithMargin(props) {
    return React__default.createElement("div", {
      className: "uaa-fieldwrap"
    }, React__default.createElement(ComponentToWrap, props));
  };
}
...
var FIELD_KIND = 'filled';

var withKind = function withKind(props) {
  return _objectSpread2({}, props, _defineProperty({}, FIELD_KIND, true));
};

var SelectFieldWithMargin = withMargin(uiCore.SelectField);
var Category = function Category(props) {
  return React__default.createElement(SelectFieldWithMargin, _extends({}, withKind(props), {
    name: "category",
...
var AggregationLevel = function AggregationLevel(props) {
  return React__default.createElement(SelectFieldWithMargin, _extends({}, withKind(props), {
    name: "aggregationLevel",
    label: i18n.t('Aggregation Level')
  }), AGGREGATIONS.map(function (i) {
    return React__default.createElement("option", {
      key: i.value,
      value: i.value
    }, i.label);
...
var ChartType = function ChartType(props) {
  return React__default.createElement(SelectFieldWithMargin, _extends({}, withKind(props), {
    name: "chartType",
    label: i18n.t('Chart Type')
  }), CHART_TYPES.map(function (i) {
    return React__default.createElement("option", {
      key: i.value,
      value: i.value
    }, i.label);
...
var EventType = function EventType(props) {
  return React__default.createElement(SelectFieldWithMargin, _extends({}, withKind(props), {
    name: "eventType",
    label: i18n.t('Event Type')
  }), EVENT_TYPES.map(function (i) {
    return React__default.createElement("option", {
      key: i.value,
      value: i.value
    }, i.label);
...
var PageSize = function PageSize(props) {
  return React__default.createElement(SelectFieldWithMargin, _extends({}, withKind(props), {
    name: "pageSize",
    label: i18n.t('Page Size')
  }), PAGE_SIZES.map(function (i) {
    return React__default.createElement("option", {
      key: i.value,
      value: i.value
    }, i.label);
...
var css$2 = ".uaa-date-field {\n    position: relative;\n}\n\n.uaa-date-field.with-error {\n    margin-bottom: 0;\n    position: relative;\n}\n\n.uaa-date-field input {\n    display: block;\n    box-sizing: border-box;\n    font-size: 16px;\n    font-family: Roboto, sans-serif;\n    width: 100%;\n    height: 56px;\n    border: none;\n    padding: 15px 14px 0 8px;\n    border-radius: 5px;\n    background-color: rgba(0, 0, 10, 0.05);\n}\n\n.uaa-date-field input:focus,\n.uaa-date-field input:hover {\n    border-bottom: 2px solid #00796b;\n    padding-top: 17px;\n}\n\n.uaa-date-field input:focus {\n    outline: none;\n}\n\n.uaa-date-field label {\n    position: absolute;\n    top: 8px;\n    left: 14px;\n    font-size: 12px;\n}\n.uaa-date-input-error {\n    color: #e53935;\n    font-size: 12px;\n    display: block;\n    /* Will be rendered in the margin of the date-field\n       and not increase the date-field's height */\n    height: 0;\n}\n";
styleInject(css$2);

var START_DATE = 'startDate';
var END_DATE = 'endDate';
var ERROR_PATTERN = i18n.t('Please use the format yyyy-mm-dd');
var ERROR_END_BEFORE_START = i18n.t('End date is before start date');
var ERROR_START_AFTER_END = i18n.t('Start date is after end date'); // Very basic date input. If browser doesn't support input type date,
...
function (_Component) {
  ...
  function DateRange(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DateRange).call(this, props));
    _this.state = {
      startDateError: null,
      endDateError: null
    };
    ...
    _this.updateUsageData = lodash_debounce(props.updateUsageData, 250);
    return _this;
  }
  ...
  _createClass(DateRange, [{
    ...
    value: function onChange(key, value) {
      var _this$props = this.props,
          ...
          updateUsageData = _this$props.updateUsageData,
          dateRange = _objectWithoutProperties(_this$props, ["updateFilter", "updateUsageData"]);

      var errorKey = "".concat(key, "Error");
      var otherErrorKey = key === START_DATE ? "".concat(END_DATE, "Error") : "".concat(START_DATE, "Error");
      var error = this.getError(_objectSpread2({}, dateRange, _defineProperty({}, key, value)), key);
      var otherError = this.state[otherErrorKey] === ERROR_PATTERN ? ERROR_PATTERN : null;

      if (this.state[errorKey] !== error) {
        var _this$setState;

        this.setState((_this$setState = {}, _defineProperty(_this$setState, errorKey, error), _defineProperty(_this$setState, otherErrorKey, otherError), _this$setState));
      }
    ...
    key: "getError",
    value: function getError(dateRange, key) {
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          startDateError = _this$state.startDateError,
          endDateError = _this$state.endDateError;
      return React__default.createElement("div", {
        className: "uaa-date-range"
      }, React__default.createElement("div", {
        className: "uaa-date-field uaa-fieldwrap"
      }, React__default.createElement("label", null, i18n.t('Start Date')), React__default.createElement("input", {
        className: START_DATE,
        type: "date",
        value: startDate,
        onChange: this.onStartDateChange
      }), startDateError && React__default.createElement("span", {
        className: "uaa-date-input-error ".concat(START_DATE)
      }, startDateError)), React__default.createElement("div", {
        className: "uaa-date-field uaa-fieldwrap"
      }, React__default.createElement("label", null, i18n.t('End date')), React__default.createElement("input", {
        className: END_DATE,
        type: "date",
        value: endDate,
        onChange: this.onEndDateChange
      }), endDateError && React__default.createElement("span", {
        className: "uaa-date-input-error ".concat(END_DATE)
      }, endDateError)));
    }
  }]);
...
var CategoryDropDown = lib_4(createValueGetterForFilterKey('category'), {
  onChange: updateCategory
})(Category);
var DateRange$1 = lib_4(mapDateRangeProps, {
  updateFilter: updateFilter,
  updateUsageData: updateUsageData
})(DateRange);
var IntervalDropDown = lib_4(createValueGetterForFilterKey('interval'), {
  onChange: updateFilterAndGetData
})(Interval);
var AggregationLevelDropDown = lib_4(createValueGetterForFilterKey('aggregationLevel'), {
  onChange: updateFilter
})(AggregationLevel);
var ChartTypeDropDown = lib_4(createValueGetterForFilterKey('chartType'), {
  onChange: updateFilter
})(ChartType);
var EventTypeDropDown = lib_4(createValueGetterForFilterKey('eventType'), {
  onChange: updateFilterAndGetData
})(EventType);
var PageSizeDropDown = lib_4(createValueGetterForFilterKey('pageSize'), {
  onChange: updateFilterAndGetData
})(PageSize);
var SortOrderDropDown = lib_4(createValueGetterForFilterKey('sortOrder'), {
  onChange: updateFilterAndGetData
})(SortOrder);
function createValueGetterForFilterKey(key) {
...
function mapDateRangeProps(state) {
  return {
...
var css$3 = ".uaa-filter-sidebar {\n    flex: 0 0 280px;\n    background-color: #ffffff;\n    padding: 1rem;\n    border-right: 1px solid rgba(0, 0, 0, 0.12);\n}\n.uaa-filter-sidebar .uaa-app-header {\n    font-size: 2rem;\n    margin-bottom: 2rem;\n}\n";
styleInject(css$3);

function FilterSideBar(_ref) {
  var showDateFields = _ref.showDateFields,
      showFavoriteViewsFields = _ref.showFavoriteViewsFields,
      showTopFavoritesFields = _ref.showTopFavoritesFields;
  return React__default.createElement("aside", {
    className: "uaa-filter-sidebar"
  }, React__default.createElement("h1", {
    className: "uaa-app-header"
  }, i18n.t('Usage Analytics')), React__default.createElement(CategoryDropDown, null), showDateFields && React__default.createElement(React.Fragment, null, React__default.createElement(DateRange$1, null), React__default.createElement(IntervalDropDown, null)), showFavoriteViewsFields && React__default.createElement(React.Fragment, null, React__default.createElement(AggregationLevelDropDown, null), React__default.createElement(ChartTypeDropDown, null)), showTopFavoritesFields && React__default.createElement(React.Fragment, null, React__default.createElement(EventTypeDropDown, null), React__default.createElement(PageSizeDropDown, null), React__default.createElement(SortOrderDropDown, null)));
}
...
function mapStateToProps$1(_ref2) {
  var category = _ref2.filter.category;
  return {
...
var FilterSideBar$1 = lib_4(mapStateToProps$1)(FilterSideBar);
...
var _chart2 = _interopRequireDefault(Chart);
...
var _keyBy2 = _interopRequireDefault(keyBy_1);
...
unwrapExports(lib$3);
var lib_1$1 = lib$3.Chart;
var lib_2$1 = lib$3.defaults;
var lib_3$1 = lib$3.Scatter;
var lib_4$1 = lib$3.Bubble;
var lib_5$1 = lib$3.Polar;
var lib_6$1 = lib$3.Radar;
var lib_7$1 = lib$3.HorizontalBar;
var lib_8$1 = lib$3.Bar;
var lib_9$1 = lib$3.Line;
var lib_10$1 = lib$3.Pie;
var lib_11$1 = lib$3.Doughnut;
...
var _CATS$FAVORITE_VIEWS, _TABLE_FIELDS, _AGGREG$SUM, _AGGREG$AVERAGE, _CATS$FAVORITE_VIEWS2, _CHART_FIELDS;
var FAVORITE_VIEWS_SUM_FIELDS = [mapViews, chartViews, pivotTableViews, eventReportViews, eventChartViews, dashboardViews, dataSetReportViews];
var FAVORITE_VIEWS_AVG_FIELDS = [averageMapViews, averageChartViews, averagePivotTableViews, averageEventReportViews, averageEventChartViews, averageDashboardViews];
var FAVORITES_SAVED_FIELDS = [savedMaps, savedCharts, savedPivotTables, savedEventReports, savedEventCharts, savedDashboards, savedIndicators];
var USERS_FIELDS = [activeUsers, users];
var TABLE_FIELDS = (_TABLE_FIELDS = {}, _defineProperty(_TABLE_FIELDS, FAVORITE_VIEWS, (_CATS$FAVORITE_VIEWS = {}, _defineProperty(_CATS$FAVORITE_VIEWS, SUM, [date].concat(FAVORITE_VIEWS_SUM_FIELDS, [totalViews])), _defineProperty(_CATS$FAVORITE_VIEWS, AVERAGE, [date].concat(FAVORITE_VIEWS_AVG_FIELDS, [averageViews])), _CATS$FAVORITE_VIEWS)), _defineProperty(_TABLE_FIELDS, FAVORITES_SAVED, [date].concat(FAVORITES_SAVED_FIELDS)), _defineProperty(_TABLE_FIELDS, USERS, [date].concat(USERS_FIELDS)), _defineProperty(_TABLE_FIELDS, TOP_FAVORITES, [position, name, views, id, created]), _defineProperty(_TABLE_FIELDS, DATA_VALUES, [date, savedDataValues]), _TABLE_FIELDS);
var CHART_FIELDS = (_CHART_FIELDS = {}, _defineProperty(_CHART_FIELDS, FAVORITE_VIEWS, (_CATS$FAVORITE_VIEWS2 = {}, _defineProperty(_CATS$FAVORITE_VIEWS2, SUM, (_AGGREG$SUM = {}, _defineProperty(_AGGREG$SUM, ALL, FAVORITE_VIEWS_SUM_FIELDS), _defineProperty(_AGGREG$SUM, TOTAL, [totalViews]), _AGGREG$SUM)), _defineProperty(_CATS$FAVORITE_VIEWS2, AVERAGE, (_AGGREG$AVERAGE = {}, _defineProperty(_AGGREG$AVERAGE, ALL, FAVORITE_VIEWS_AVG_FIELDS), _defineProperty(_AGGREG$AVERAGE, TOTAL, [averageViews]), _AGGREG$AVERAGE)), _CATS$FAVORITE_VIEWS2)), _defineProperty(_CHART_FIELDS, FAVORITES_SAVED, FAVORITES_SAVED_FIELDS), _defineProperty(_CHART_FIELDS, USERS, USERS_FIELDS), _defineProperty(_CHART_FIELDS, DATA_VALUES, [savedDataValues]), _CHART_FIELDS);
...
var weekStr = i18n.t('Week');
function getDisplayDateForInterval(_ref, interval) {
  var year = _ref.year,
      month = _ref.month,
      week = _ref.week,
      day = _ref.day;
  ...
  switch (interval) {
    ...
    case WEEK:
      return "".concat(weekStr, " ").concat(week, " / ").concat(year);
...
function getDisplayDateFromIsoString(isoString) {
  var date = new Date(isoString);
  return getDisplayDate(date, dateFormats.yyyymmdd);
}
function getDisplayDateFromYearMonthDay(year, month, day) {
  var date = day ? new Date(year, month - 1, day) : new Date(year, month - 1);
  var format = day ? dateFormats.yyyymmdd : dateFormats.yyyymm;
  return getDisplayDate(date, format);
}

function getDisplayDate(date, dateFormatOptions) {
  var state = store.getState();
  var locale = state.locale || 'en';
  return new Intl.DateTimeFormat(locale, dateFormatOptions).format(date);
}

var colors = ['#7cb5ec', '#CC6600', '#CCCC00', '#66CC00', '#ff0066', '#000000', '#00CCCC'];
var options = {
  animation: {
    duration: 180
  },
...
var MIN_SUGGESTED_MAX_VALUE = 1;
function parseChartData(_ref, dataPoints) {
  var aggregationLevel = _ref.aggregationLevel,
      category = _ref.category,
      chartType = _ref.chartType,
      interval = _ref.interval;
  var labels = [];
  var datasets = [];
  var title = CATEGORY_LOOKUP[category].label;
  var subtitle = CATEGORY_LOOKUP[category].subtitle;
  var max = MIN_SUGGESTED_MAX_VALUE;
  var min = null;
  var fields = category === FAVORITE_VIEWS ? CHART_FIELDS[category][aggregationLevel][chartType] : CHART_FIELDS[category];
  var dataPointsLen = dataPoints.length;
  var fieldsLen = fields.length;

  for (var dataPointIndex = 0; dataPointIndex < dataPointsLen; dataPointIndex++) {
    var dataPoint = dataPoints[dataPointIndex];
    labels.push(getDisplayDateForInterval(dataPoint, interval));

    for (var fieldIndex = 0; fieldIndex < fieldsLen; fieldIndex++) {
      var field = fields[fieldIndex];

      if (dataPointIndex === 0) {
        datasets.push(_objectSpread2({}, dataSet, {
          label: field.label,
          data: [],
      ...
      var pointValue = dataPoint[field.key];
  ...
  options.onResize = onChartResize;
  return {
    data: {
      labels: labels,
      datasets: datasets
...
var css$4 = ".uua-chart-container {\n    padding: 16px 8px;\n    margin-bottom: 0;\n}\n\n.uaa-chart-wrap {\n    position: relative;\n    /* \n       24 x 2 (padding around containers) = 48\n       20 + 8 (title)                     = 28\n       14 + 4 (sub title)                 = 18 +\n       -----------------------------------------\n                                    total = 94\n    */\n    height: calc(50vh - 94px);\n    max-height: 800px;\n}\n\n.uaa-chart-title {\n    font-size: 20px;\n    margin: 0;\n    text-align: center;\n    margin-bottom: 8px;\n}\n\n.uaa-chart-subtitle {\n    font-size: 14px;\n    margin: 0;\n    text-align: center;\n    color: rgba(0, 0, 0, 0.7);\n    margin-bottom: 4px;\n}\n";
styleInject(css$4);

var baseClassName = 'uua-data-container uua-chart-container';
var loadingClassName = ' uua-data-container--loading';
function Chart$1(_ref) {
  var shouldHide = _ref.shouldHide,
  ...
  if (shouldHide) {
    ...
    content = React__default.createElement(uiCore.CircularLoader, {
      overlay: true
    });
  } else {
    ...
    content = React__default.createElement(React.Fragment, null, React__default.createElement("h4", {
      className: "uaa-chart-title"
    }, title), React__default.createElement("h6", {
      className: "uaa-chart-subtitle"
    }, subtitle), React__default.createElement("div", {
      className: "uaa-chart-wrap"
    }, React__default.createElement(lib_9$1, {
      data: data,
      options: options
    })));
  }

  var className = loading ? baseClassName + loadingClassName : baseClassName;
  return React__default.createElement("div", {
    className: className
  }, content);
}
...
function mapStateToProps$2(_ref2) {
  var usageData = _ref2.usageData,
      filter = _ref2.filter;
  var shouldHide = filter.category === TOP_FAVORITES || usageData === ERROR;
  var loading = usageData === LOADING;
  return {
...
var Chart$2 = lib_4(mapStateToProps$2)(Chart$1);

var css$5 = ".uaa-data-table {\n    width: 100%;\n}\n.uaa-data-table thead {\n    border-bottom: 2px solid #e0e0e0;\n}\n\n.uaa-data-table tbody tr {\n    border-bottom: 1px solid #e0e0e0;\n}\n\n.uaa-data-table th,\n.uaa-data-table td {\n    font-size: 14px;\n    padding: 16px 16px;\n}\n.uaa-data-table th {\n    text-align: left;\n    font-weight: bold;\n}\n";
styleInject(css$5);

var baseClassName$1 = 'uua-data-container';
var loadingClassName$1 = ' uua-data-container--loading';
var TableHead = function TableHead(_ref) {
  var headers = _ref.headers;
  return React__default.createElement("thead", null, React__default.createElement("tr", null, headers.map(function (header, i) {
...
var TableBody = function TableBody(_ref2) {
  var rows = _ref2.rows;
  return React__default.createElement("tbody", null, rows.map(function (row, i) {
...
var TableRow = function TableRow(_ref3) {
  ...
  return React__default.createElement("tr", null, cells.map(function (text, i) {
...
function Table(_ref4) {
  ...
  if (error) {
    content = React__default.createElement(Error$1, {
      message: i18n.t('There was an error retrieving the usage analytics data')
    });
  } else if (loading) {
    content = React__default.createElement(uiCore.CircularLoader, {
      overlay: true
    ...
    var headers = tableData.headers,
        rows = tableData.rows;
    content = React__default.createElement("table", {
      className: "uaa-data-table"
  ...
  var className = loading ? baseClassName$1 + loadingClassName$1 : baseClassName$1;
  return React__default.createElement("div", {
    className: className
  }, content);
}
...
function mapStateToProps$3(_ref5) {
  var usageData = _ref5.usageData,
      filter = _ref5.filter;
  var error = usageData === ERROR;
  var loading = usageData === LOADING;
  return {
    error: error,
    loading: loading,
...
function parseTableData(_ref6, dataPoints) {
  var aggregationLevel = _ref6.aggregationLevel,
      category = _ref6.category,
      interval = _ref6.interval;
  var fields = category === FAVORITE_VIEWS ? TABLE_FIELDS[category][aggregationLevel] : TABLE_FIELDS[category];
  return {
    headers: fields.map(function (_ref7) {
      var label = _ref7.label;
      return label;
    }),
    rows: dataPoints.map(function (dataPoint) {
      return fields.map(function (field) {
        if (field.key === date.key) {
          return getDisplayDateForInterval(dataPoint, interval);
        }

        if (field.key === created.key) {
...
var Table$1 = lib_4(mapStateToProps$3)(Table);

var UsageAnalytics =
/*#__PURE__*/
function (_Component) {
  _inherits(UsageAnalytics, _Component);

  function UsageAnalytics() {
    _classCallCheck(this, UsageAnalytics);

    return _possibleConstructorReturn(this, _getPrototypeOf(UsageAnalytics).apply(this, arguments));
  }

  _createClass(UsageAnalytics, [{
    ...
    key: "render",
    value: function render() {
      var appStatus = this.props.appStatus;

      if (appStatus === LOADING) {
        return React__default.createElement(uiCore.CircularLoader, {
          overlay: true,
          size: "large"
        });
      }
      ...
      if (appStatus === ERROR) {
        return React__default.createElement(Error$1, {
          message: i18n.t('Error loading application.')
        });
      }

      return React__default.createElement("main", {
        className: "uaa-container"
      }, React__default.createElement(FilterSideBar$1, null), React__default.createElement("section", {
        className: "uaa-content"
      }, React__default.createElement(Chart$2, null), React__default.createElement(Table$1, null)));
    }
  }]);
...
var UsageAnalytics$1 = lib_4(mapStateToProps$4, {
  initApp: initApp
})(UsageAnalytics);

var css$6 = "body {\n    margin: 0;\n    padding: 0;\n    overflow-y: scroll;\n}\n\n.uaa-container {\n    display: flex;\n    min-height: calc(100vh - 48px);\n    background-color: rgba(0, 0, 10, 0.05);\n    font-family: 'Roboto', sans-serif;\n}\n\n.uaa-content {\n    flex: 1;\n}\n\n.uua-data-container {\n    margin: 16px;\n    border-radius: 2px;\n    background-color: #fff;\n    box-shadow: 0 0 2px 0 rgba(0, 0, 0, 0.14), 0 2px 2px 0 rgba(0, 0, 0, 0.12),\n        0 1px 3px 0 rgba(0, 0, 0, 0.2);\n    position: relative;\n    /* Extra px helps Chart.js scale itself correctly */\n    max-width: calc(100% - 33px);\n}\n\n.uua-data-container--loading {\n    min-height: calc(50vh - 48px);\n}\n";
styleInject(css$6);

function App() {
  return React__default.createElement(lib_1, {
    store: store
  }, React__default.createElement(UsageAnalytics$1, null));
}
